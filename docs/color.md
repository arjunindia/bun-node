...
You can think of this as an alternative to the popular npm packages `color` and `tinycolor2` except with full support for parsing CSS color strings and zero dependencies built directly into Bun.
